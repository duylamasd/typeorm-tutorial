...
export class createTables1544027904853 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `message_closure` (`id_ancestor` varchar(255) NOT NULL, `id_descendant` varchar(255) NOT NULL, PRIMARY KEY (`id_ancestor`, `id_descendant`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `message_closure` ADD CONSTRAINT `FK_fc14e2b773be0b7820cc4d44c15` FOREIGN KEY (`id_ancestor`) REFERENCES `message`(`id`)");
        await queryRunner.query("ALTER TABLE `message_closure` ADD CONSTRAINT `FK_9c1a899a4d4b1af96a74bdded8a` FOREIGN KEY (`id_descendant`) REFERENCES `message`(`id`)");
    }

    public async down(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `message_closure` DROP FOREIGN KEY `FK_9c1a899a4d4b1af96a74bdded8a`");
        await queryRunner.query("ALTER TABLE `message_closure` DROP FOREIGN KEY `FK_fc14e2b773be0b7820cc4d44c15`");
